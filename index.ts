...
const friends_name: string[] = ["zeeshan", "mohsin", "irfan"];
friends_name.forEach((name: string) => {
  console.log(name);
});

//  Question # 12
// Greetings: Start with the array you used in Exercise 11, but instead of just printing each person’s name, print a message to them. The text of each message should be the same, but each message should be personalized with the person’s name.
friends_name.forEach((friend_name: string) => {
  console.log(`I would like to have a conversation with Mr. ${friend_name}.`);
});
...
const guests: string[] = ["zeeshan", "mohsin", "irfan"];
